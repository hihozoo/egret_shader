...
namespace SpecialEffects {
  ...
  export class EffectSwirl extends IEffect {
    ...
    public constructor(target) {
      ...
      target.filters = [createCustomFilter(SWIRL_F_SHADER, this.uniform)];
    }
    /** 0-n */
  ...
  export class EffectBulgePinch extends IEffect {
    ...
    public constructor(target) {
      ...
      target.filters = [createCustomFilter(BULGE_PICH_F_SHADER, this.uniform)];
    }
    /** 0-n */
  ...
  export class EffectPerspective extends IEffect {
    ...
    public constructor(target) {
      ...
      target.filters = [createCustomFilter(PERSPECTIVE_F_SHADER, this.uniform)];
    }
